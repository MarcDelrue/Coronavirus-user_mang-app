...
var FirebaseService = /** @class */ (function () {
    function FirebaseService(firestore, afDB, afSG) {
    ...
    FirebaseService.prototype.getUserById = function (id) {
        return this.firestore.collection('user_data').doc(id);
    };
    FirebaseService.prototype.createUser = function (name, uid, id) {
        var accept_modify_account;
        uid != "" ? accept_modify_account = false : accept_modify_account = true;
        return this.firestore.collection('user_data').doc(id).set({
            id: id,
            name: name,
            uid: uid,
            accept_modify_account: accept_modify_account,
    ...
    FirebaseService.prototype.switchProgramStatus = function (newState) {
        return this.firestore.collection("python_function").doc("g9y4AYxRUFBkTnUDvxW2").update({ is_launched: newState });
    };
    FirebaseService.prototype.getSwitchState = function () {
        return this.firestore.collection('python_function');
    };
    FirebaseService.prototype.deleteAllImagesFromUser = function (all_images) {
        for (var _i = 0, all_images_1 = all_images; _i < all_images_1.length; _i++) {
            var image = all_images_1[_i];
            this.deleteImage(image);
        }
    };
    FirebaseService.prototype.deleteImage = function (image) {
