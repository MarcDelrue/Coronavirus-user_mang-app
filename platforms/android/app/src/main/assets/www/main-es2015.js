...
const routes = [
    ...
    {
        path: 'user',
        loadChildren: () => Promise.all(/*! import() | user-component-user-component-module */[__webpack_require__.e("common"), __webpack_require__.e("user-component-user-component-module")]).then(__webpack_require__.bind(null, /*! ./user-component/user-component.module */ "./src/app/user-component/user-component.module.ts")).then(m => m.UserComponentPageModule)
    },
];
